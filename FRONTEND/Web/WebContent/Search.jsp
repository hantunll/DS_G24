...
<div class='note'>
<img src="images/pencil.png" style = 'position:absolute;width:40px;height:40px;margin-top:520px' >
</div> 
<div class='note1'>
<img src="images/pencil.png" style = 'position:absolute;width:40px;height:40px;margin-top:520px' >
</div> 
<div class='note2'>
<img src="images/onebook.png" style = 'position:absolute;width:40px;height:40px;margin-top:520px' >
</div>
<div class='note3'>
<img src="images/onebook.png" style = 'position:absolute;width:40px;height:40px;margin-top:520px' >
</div>  
...
margin-top:-47px;margin-left:-400px;width:800px;height:45px' name='keyword' placeholder='Please enter your keyword!!'
onfocus="placeholder= '' " onblur="placeholder='Please enter your keyword!!'" />
</div>
<div>
...
<div>
<a href ='http://localhost:8080/Final_Project/TestProject'><img src="images/books.jpg" style='position:absolute;width:350px;height:150px;left:50%;top:50%;margin-top:-265px;
margin-left:-175px '></a>
</div>
</form>
</body>
